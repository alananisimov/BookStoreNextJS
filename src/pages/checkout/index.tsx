...
export default function Checkout(){
    ...
    return(
        ...
        <Layout>
            <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32" suppressHydrationWarning={true}>
    ...
    <div className="relative">
      <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
        <li className="flex items-center space-x-3 text-left sm:space-x-4">
          ...
          ></a>
          <span className="font-semibold text-gray-900">Покупка</span>
        </li>
        ...
        <li className="flex items-center space-x-3 text-left sm:space-x-4">
          ...
          <span className="font-semibold text-gray-900">Оформление</span>
        </li>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
        </svg>
        <li className="flex items-center space-x-3 text-left sm:space-x-4">
          ...
          <span className="font-semibold text-gray-500">Оплата</span>
        </li>
      </ul>
    </div>
  </div>
...
<div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  <div className="px-4 pt-8">
    ...
    <p className="text-gray-400">Проверьте ваши покупки и оставьте реквизиты для оплаты</p>
  ...
  <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div className="">
      ...
      <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-medium">Владелец карты</label>
      <div className="relative">
      ...
      <label htmlFor="card-no" className="mt-4 mb-2 block text-sm font-medium">Инфорамация карты</label>
      <div className="flex">
      ...
      <div className="mt-6 border-t border-b py-2">
        <div className="flex items-center justify-between">
          <p className="text-sm font-medium text-gray-900">Промежуточный итог</p>
          <p className="font-semibold text-gray-900">$<CartPrice/></p>
        </div>
       
      </div>
      <div className="mt-6 flex items-center justify-between">
        <p className="text-sm font-medium text-gray-900">Итого</p>
        <p className="text-2xl font-semibold text-gray-900">$<CartPrice/></p>
      </div>
    </div>
    <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white" onClick={()=>{router.push("/checkout/pay")}}>Оплатить</button>
  </div>
</div>
