...
const product = {
  ...
  rating: product_props.rating,
  reviewCount: 117,
  href: '#',
  imageSrc: product_props.image,
                  ...
                  <div className="grid w-full grid-cols-1 items-center gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                    ...
                    <div className="sm:col-span-8 lg:col-span-7">
                      ...
                      <section aria-labelledby="information-heading" className="mt-2">
                        ...
                        <p className="text-2xl text-gray-900">{product.price} USD</p>
                        ...
                        <div className="mt-6">
                          ...
                          <div className="flex items-center">
                            ...
                            <p className="sr-only">{product.rating.count} out of 5 stars</p>
